    ...
    return (
        <div id="faq" className="block faqBlock">
            ...
            <div className="quickSupport">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Pariatur velit necessitatibus praesentium aliquid eos in neque recusandae, 
                incidunt esse dolore voluptatum nesciunt quod soluta consequuntur voluptatibus ab excepturi nobis! Porro!</p>
                <Button type="button" className="ant-btn ant-btn-primary ant-btn-lg"><i className="fas fa-envelope"></i><span> Email your question</span></Button>
            </div>
            </div>
        </div>
    )
